<template>
  <div>
    <section class="profile">
      ...
      <section class="profile-number" @click="$router.push('/login')"> <!--@click="$router.push(user._id ? '/userinfo' : '/login')"-->
      ...
      <section class="profile_my_order border-1px" v-if="user.name">
